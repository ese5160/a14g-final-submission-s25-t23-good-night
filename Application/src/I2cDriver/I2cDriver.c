...
static int32_t I2cDriverConfigureSensorBus(void)
{
    ...
    config_i2c_master.pinmux_pad0 = PINMUX_PA04D_SERCOM0_PAD0;//PINMUX_PA08C_SERCOM0_PAD0;//
    config_i2c_master.pinmux_pad1 = PINMUX_PA05D_SERCOM0_PAD1;//PINMUX_PA09C_SERCOM0_PAD1;//
